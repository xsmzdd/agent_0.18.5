...
case $architecture in
    x86_64)
        ...
        wget https://github.com/nezhahq/agent/releases/download/v0.15.15/nezha-agent_linux_amd64.zip \
       #wget https://github.com/nezhahq/agent/releases/download/v0.18.4/nezha-agent_linux_amd64.zip \
    ...
    arm64|aarch64)
        ...
        wget https://github.com/nezhahq/agent/releases/download/v0.15.15/nezha-agent_linux_arm64.zip \
       #wget https://github.com/nezhahq/agent/releases/download/v0.18.4/nezha-agent_linux_arm64.zip \
